$(document).ready(function() {
    const apiRoot = 'http://tasks-prod-kodilla-tasks-3za3mi.mo6.mogenius.io/v1/tasks';
    const trelloApiRoot = 'http://tasks-prod-kodilla-tasks-3za3mi.mo6.mogenius.io/v1/trello';
